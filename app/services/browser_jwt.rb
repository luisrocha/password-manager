...
module BrowserJwt
  ...
  AUDIENCE = 'password-manager-extension'
  ALGORITHM = 'HS256'
  ENCRYPTION_CIPHER = 'aes-256-gcm'
  TOKEN_PURPOSE = 'browser-api-jwt'
  ...
  def decode_jwt(jwt)
    ...
    raise JWTError, 'Invalid signature' unless secure_compare(provided_signature, expected_signature)
